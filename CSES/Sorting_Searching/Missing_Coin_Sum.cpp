...
int main() {
    ...
    // Logic specific to sequence from 1 to n. All numbers lesser than a given number can be formed by the sum of two numbers if the greater number is also formed by sum of two numbers
