...
// or
int longestOnes_Striver(vector<int>&nums,int k) {
    int n = nums.size();
    int left = 0,right = 0;
    int maxlen = 0;
    while(right < n) {
...
int main() {
    ...
    cout << longestOnes_Striver(nums,2) << endl;

    cout << longestOnes_Striver(temp,2) << endl;

    cout << longestOnes_Striver(temp1,3) << endl;
